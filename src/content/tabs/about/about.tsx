...
export class About extends React.Component<{}, {}> {
  render() {
    return <article id="bio-tab" className="about-section">
      ...
      <p>The intent of this site is to be a home for my personal projects, a resource for those who would utilize them, and a portfolio for those interested in my code. It is
      also in constant development, so expect to see regular changes (assuming I'm as attentive to this as I'd like to be).</p>
